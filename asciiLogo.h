...
const array<string, 16> logo2 = { R"(PPPPPP PPPPPPPPPP   RRRRR RRRRR RRRRR        OOO OOOOO     TTTTTTTTT TTTTTTTT TTTT     OOOO OOOO     ZZZZZZ ZZZZZ ZZZZZZ     O OO OO O                 AAA               )",
...
const array<string, 16> logo3 = { R"(P  PP P  P PP PP    RRR R RRR RRRRRRR        OOO OO OO     TTTT TT TTTT TTT TT TTT     OOO OOOO      ZZ  Z ZZZZ ZZZ Z ZZ     O OOO O O                 AAA               )",
...
const array<string, 16> logo4 = { R"(P  P  P  P P  PP    R R R RR  RR R RR        OO  OO OO     TT T TT T TT T T TT T T     O   OO O      Z   Z Z Z  Z Z Z ZZ     O O O O O                 AAA               )",
R"(P: : :  : :  : :    R : :  : : :  : :R         :: : : O      ::  ::   :  : :: : :T   O ::  :  : O     : : :: :  : :  ::      :: : : :  O              A :                )",
...
const array<string, 16> logo5 = { R"(P     P  P     P    R   R R   R  R R         O    O  O      T T T  T  T T    T T       O    O            Z   Z  Z   Z Z      O O   O                   AAA               )",
R"(P: : :  : :    :    R : :  :   :  : :          :  :   O               :  : :  : :    O :   :    O       :       : :   :      :    : :                 A                  )",
R"( :  :           :     :     R       :        :    :    :     :    :   :  :       T     :    :   :            :   : : :        :  :   :                 :                 )",
R"(P  :  :           :   : :         :   :  :  :     O    : :  :   :  :  :      :     :     :         :    :      Z  :  :  O    : :     :  : O         A   :  :             )",
R"(    :  P      : : :     ::       R :  :  :                                     T   :   :     O   :       Z      :  :      :           :  :           : :   : A           )",
...
const array<string, 16> logo6 = { R"(P        P                R      R                   O      T                  T            O            Z            Z        O                       A                 )",
R"(     :         :        :           :          :                           :  :      O :                              :      :    :                   A                  )",
R"( :  :           :     :             :        :    :    :     :           :                                   :       :        :                                          )",
R"(P  :  :                                                            :  :      :                          :                            :  : O             :                )",
R"(    :                   :                :                                                       :           :  :                                          : A           )",
